              ...
              <>
                ...
                {selectedFile.status === "success" && selectedFile.result && (
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">請求書番号</label>
                      <p className="text-foreground">{selectedFile.result.invoice.invoiceNumber}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">顧客名</label>
                      <p className="text-foreground">{selectedFile.result.invoice.client?.name}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">合計金額</label>
                      <p className="text-foreground text-xl font-bold">
                        ¥{selectedFile.result.invoice.total?.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-muted-foreground">信頼度</label>
                      <div className="flex items-center gap-2">
