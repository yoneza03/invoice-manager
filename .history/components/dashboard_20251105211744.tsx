    ...
    <div className="p-8 lg:p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-shadow">
          ...
          <p className="text-3xl font-bold text-foreground">¥166,200</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-shadow">
          ...
          <p className="text-3xl font-bold text-foreground">¥118,900</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-xs font-semibold text-yellow-600">12件</span>
          </div>
          <p className="text-muted-foreground text-sm mb-1">未払い金額</p>
          <p className="text-3xl font-bold text-foreground">¥35,500</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 hover:shadow-lg transition-shadow">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-xs font-semibold text-destructive">3件</span>
          </div>
          <p className="text-muted-foreground text-sm mb-1">期限切れ金額</p>
          <p className="text-3xl font-bold text-foreground">¥11,800</p>
        </div>
      </div>
            ...
            <tbody>
              {recentInvoices.map((invoice) => (
                <tr key={invoice.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-sm text-foreground">{invoice.client}</td>
                  <td className="py-3 px-4 text-sm font-semibold text-foreground">{invoice.amount}</td>
