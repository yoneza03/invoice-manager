...
// Noto Sans JPフォントを登録（Google Fontsから取得可能）
// 本番環境では /public/fonts/ に配置することを推奨
Font.register({
  family: "NotoSansJP",
  fonts: [
    {
      src: "https://fonts.gstatic.com/s/notosansjp/v52/-F6jfjtqLzI2JPCgQBnw7HFyzsd_.woff2",
      fontWeight: 400,
    },
    {
      src: "https://fonts.gstatic.com/s/notosansjp/v52/-F6pfjtqLzI2JPCgQBnw7HFQaioq1H0.woff2",
      fontWeight: 700,
    },
  ],
})
